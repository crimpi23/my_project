...
def compare_prices():
    ...
    if request.method == 'POST':
        try:
            ...
            # Search for prices in selected tables
            results = {}
...
def export_to_excel(better_in_first, better_in_second, same_prices):
    try:
        ...
        # Create a sheet for same prices
